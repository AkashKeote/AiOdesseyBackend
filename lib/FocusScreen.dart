...
class _FocusscreenState extends State<Focusscreen> {
        ...
        body: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final scale = screenWidth < 400
                ? (screenWidth - spacing * 3) / (itemWidth * 2)
                : 1.0;
  ...
  Widget _buildResponsiveGrid(
      double scale, double spacing, BuildContext context) {
    return Column(
      children: [
        _buildResponsiveRow(
          ...
          onTap: () => Navigator.push(
              context, MaterialPageRoute(builder: (context) => Timerscreen(selectedTopic: 'YourTopic'))),
        ),
        SizedBox(height: spacing),
        _buildResponsiveRow(
